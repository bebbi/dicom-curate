// Hand-constructed as an example config for file-drop use case
// TODO: integrate this with the tsx script workflow in package.json
...
curationSpecification = () => {
  ...
  return {
    ...
    modifications(parser) {
      const scan = parser.getDicom('Modality')
      const centerSubjectId = parser.getDicom('PatientID')
