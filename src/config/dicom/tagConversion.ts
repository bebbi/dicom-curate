 ...
 * Private tags have odd group numbers (e.g., 0005, 0007, 0009, etc.)
 */
 ...
 * Uses dcmjs built-in conversion for standard DICOM keywords
 * For private tags (which don't have keywords), keeps as-is
 */
 ...
 * Handles nested paths like "GeneralMatchingSequence[0].00510014"
 */
